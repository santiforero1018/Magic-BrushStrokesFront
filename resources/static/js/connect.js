var connect = (function () {
    ...
    var connectAndSubscribe = function () {
        ...
        var socket = new SockJS("https://magic-brusstrokesback.azurewebsites.net/stompendpoint");  // Cambiar al momento de subir a azure
    ...
    var requestCanvasAssignment = function (roomCode) {
        return new Promise((resolve, reject) => {
            ...
            $.ajax({
                url: "https://magic-brusstrokesback.azurewebsites.net/API-v1.0MagicBrushStrokes/board", // Cambiar al momento de subir a azure
                type: 'POST',
