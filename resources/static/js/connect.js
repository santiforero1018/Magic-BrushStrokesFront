var connect = (function () {
    ...
    var connectAndSubscribe = function () {
        ...
        var socket = new SockJS("https://magickbrushstrokesback.azurewebsites.net:443//stompendpoint");  // Cambiar al momento de subir a azure
    ...
    var requestCanvasAssignment = function (roomCode) {
        return new Promise((resolve, reject) => {
            ...
            $.ajax({
                url: "https://magickbrushstrokesback.azurewebsites.net:443//API-v1.0MagicBrushStrokes/board", // Cambiar al momento de subir a azure
                type: 'POST',
